...
python3 platforms/claude/skills/bird-twitter-bookmarks/scripts/bookmark_l2_labels.py --help
```

## L2 标签命令

```bash
SCRIPT="platforms/claude/skills/bird-twitter-bookmarks/scripts/bookmark_l2_labels.py"
